...
void create_main_screen(lv_obj_t *scr)
{
    ...
    // Añadimos offset_y a la estructura
    struct
    {
        const char *label;
        lv_color_t color;
        lv_align_t align;
        int offset_x;
        int offset_y; // Nuevo campo para el desplazamiento en Y
    } buttons[] = {
        {"START", lv_color_hex(0x32CD32), LV_ALIGN_BOTTOM_LEFT, +10, -10},
        {"STOP", lv_color_hex(0xFF4500), LV_ALIGN_BOTTOM_LEFT, +150, -10},
        {"RESET", lv_color_hex(0xFFA500), LV_ALIGN_BOTTOM_RIGHT, -150, -10},
        {"RST CNT", lv_color_hex(0x333333), LV_ALIGN_BOTTOM_RIGHT, -10, -10},
        {"PRELOAD", lv_color_hex(0x333333), LV_ALIGN_BOTTOM_LEFT, +300, -10},
        {"NEW BTN 1", lv_color_hex(0xFF0000), LV_ALIGN_BOTTOM_LEFT, +10, -70},
        {"NEW BTN 2", lv_color_hex(0x00FF00), LV_ALIGN_BOTTOM_LEFT, +10, -130},
    ...
    for (int i = 0; i < NumButtons; i++)
    {
        ...
        // Usar offset_x y offset_y para posicionar cada botón
        lv_obj_align(btn, buttons[i].align, buttons[i].offset_x, buttons[i].offset_y);
